...
import { useOrganizations, useOrganizationSummary } from "@/hooks/useOrganizations";
...
export default function SettingsPage() {
  const { user } = useAuth();
  const { currentOrg, currentOrgId, updateOrganization, isUpdating } = useOrganizations();
  const { data: summary, isLoading: summaryLoading } = useOrganizationSummary(currentOrgId);
  ...
  const handleSaveOrganization = async (e: React.FormEvent) => {
    ...
    try {
      await updateOrganization({ id: currentOrgId, data: { name: orgName.trim() } });
              ...
              <form onSubmit={handleSaveOrganization} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={currentOrg?.name || "Enter organization name"}
                ...
                <button
                  type="submit"
                  disabled={isSaving || isUpdating || orgName.trim() === currentOrg?.name}
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-secondary/50">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold">{summary.membersCount}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-secondary/50">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold">{summary.accountsCount}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-secondary/50">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold">{summary.transactionsCount}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
