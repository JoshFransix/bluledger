          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col sm:flex-row items-start gap-6">
                <div
                  className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-accent
                  ...
                  {teamMembers.map((member) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/50 to-accent/50
          ...
          <Card className="border-primary/30">
            ...
            <CardContent>
              <div className="p-4 bg-primary/10 rounded-lg mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Billed monthly • Renews Dec 1, 2025
                </p>
              </div>
              ...
              <button
                className="w-full px-4 py-2 bg-secondary hover:bg-secondary/80
                                 rounded-lg transition-colors text-sm font-medium"
              >
                Upgrade Plan
              </button>
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        />
        <div
          className="w-11 h-6 bg-secondary rounded-full peer 
  ...
  return (
    <div className="p-6 space-y-4">
      {[...Array(4)].map((_, i) => (
        <div
          key={i}
          className="h-14 animate-pulse bg-secondary/50 rounded-lg"
        />
      ))}
    </div>
  );
  ...
  return (
    <div className="p-6 space-y-3">
      {[...Array(4)].map((_, i) => (
        <div
          key={i}
          className="h-10 animate-pulse bg-secondary/50 rounded-lg"
        />
      ))}
    </div>
  );
